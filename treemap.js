...
function reSortRoot(root,value_key) {
  ...
  $( document ).ready(function() {
    ...
    // loadJSONFile('data/portaldata.json');
      ...
      d3.csv("https://nicoescobedo.github.io/tarea/Nico/aprobacion.csv", function(csv_data){

      // Add, remove or change the key values to change the hierarchy. 
      var nested_data = d3.nest()
              .key(function(d)  { return d.aprobacion_presidencial; })
              .key(function(d)  { return d.zona; })
              .key(function(d)  { return d.tendencia; })
      ...
      root.key = "Aprobación Presidencial";
